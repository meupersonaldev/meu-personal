    ...
    <footer className="py-12 lg:py-16 bg-meu-primary-dark border-t border-meu-accent/20">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        <div className="flex justify-center">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-16 xl:gap-20 mb-8 lg:mb-12 w-full max-w-5xl">
            <div className="flex flex-col items-center sm:items-start">
              <h4 className="font-semibold mb-4 lg:mb-6 text-white text-lg">Para Alunos</h4>
              <ul className="space-y-2.5 text-gray-300 text-center sm:text-left">
