      ...
      <div className="flex-1 flex items-center justify-center p-8 lg:p-16">
        <div className="w-full max-w-md">
          ...
          <div className="hidden lg:block mb-12">
            ...
            <p className="text-gray-600 text-lg">Comece sua jornada fitness conosco hoje.</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
                ...
                <button
                  ...
                  className={`p-4 rounded-lg border-2 transition-all duration-200 ${
                    formData.role === 'STUDENT'
                      ? 'border-meu-accent bg-meu-accent/5'
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="w-full px-3 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-meu-accent focus:border-transparent"
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="w-full px-3 py-3 pr-10 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-meu-accent focus:border-transparent"
          ...
          <div className="text-center mt-6">
            <p className="text-sm text-gray-600">
              ...
              <Link
                href="/login"
                className="text-meu-primary hover:text-meu-accent font-medium transition-colors"
              >
                Fazer login
              </Link>
            </p>
