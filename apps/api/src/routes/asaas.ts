...
router.post('/accounts', requireAuth, async (req, res) => {
  try {
    ...
    // Converter para AsaasAccount (campos obrigatórios já validados pelo Zod)
    const data = {
      ...
      ...(validatedData.loginEmail && { loginEmail: validatedData.loginEmail }),
      ...(validatedData.birthDate && { birthDate: validatedData.birthDate }),
      ...(validatedData.companyType && { companyType: validatedData.companyType }),
      ...(validatedData.phone && { phone: validatedData.phone }),
      ...(validatedData.site && { site: validatedData.site }),
      ...(validatedData.complement && { complement: validatedData.complement }),
      ...(validatedData.webhooks && { webhooks: validatedData.webhooks })
    }
